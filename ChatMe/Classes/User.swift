...
class User {
    ...
    class func registerUserWith(email: String, password: String, firstName: String, lastName: String, avatar: String = "", completion: @escaping (_ error: Error?) -> Void ) {
        ...
        Auth.auth().createUser(withEmail: email, password: password, completion: { (firuser, error) in
            ...
            let fUser = User(_objectId: firuser!.user.uid, _pushId: "", _createdAt: Date(), _updatedAt: Date(), _email: firuser!.user.email!, _firstname: firstName, _lastname: lastName, _avatar: avatar, _loginMethod: kEMAIL, _phoneNumber: "", _city: "", _country: "")
        ...
        Auth.auth().signInAndRetrieveData(with: credential) { (firuser, error) in
            ...
            fetchCurrentUserFromFirestore(userId: firuser!.user.uid, completion: { (user) in
                ...
                if user != nil && user!.firstname != "" {
                    ...
                    let fUser = User(_objectId: firuser!.user.uid, _pushId: "", _createdAt: Date(), _updatedAt: Date(), _email: "", _firstname: "", _lastname: "", _avatar: "", _loginMethod: kPHONE, _phoneNumber: firuser!.user.phoneNumber!, _city: "", _country: "")
...
func saveUserToFirestore(fUser: User) {
...
func checkBlockStatus(withUser: User) -> Bool {
